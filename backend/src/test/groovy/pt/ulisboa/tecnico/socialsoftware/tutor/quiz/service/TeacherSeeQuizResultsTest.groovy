...
class TeacherSeeQuizResultsTest extends SpockTest {
    ...
    def "returns solved quiz with: quizType=#quizType | conclusionDate=#conclusionDate | resultsDate=#resultsDate"() {
        ...
        when:
        def quizAnswersDtos = quizService.getQuizAnswers(quiz.getId())

        then: 'returns correct data'
        quizAnswersDtos.getCorrectSequence().get(0) == OPEN_QUESTION_1_ANSWER
        def quizAnswerDto = quizAnswersDtos.getQuizAnswers().get(0)
        quizAnswerDto.getName() == USER_1_NAME
        quizAnswerDto.getUsername() == USER_1_USERNAME
        quizAnswerDto.getAnswerDate() != null
        quizAnswerDto.getQuestionAnswers() != null
